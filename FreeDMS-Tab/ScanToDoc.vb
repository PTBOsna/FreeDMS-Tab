...
#Region "Datensatz füllen"
    ...
    Private Sub CbAkteNeu_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbAkteNeu.SelectedIndexChanged
        If cbAkteNeu.SelectedIndex >= 0 Then
            AktenVorgaengeBindingSource.Filter = "Akte=" & cbAkteNeu.SelectedValue.ToString
    ...
    Private Sub SaveDoc()
        ...
        If DokInhalt.Count > 0 Then
            ...
            For Each el In DokInhalt
                If el.docID.ToString.Contains((anzahlDS + 1).ToString) Then
                    With NewRow
                        .Mandant = el.mandant
                        .Akte = el.akte
                        .Vorgang = el.vorgang
